...
<div {{ $attributes->merge(['class' => 'table-row row']) }}>
    ...
    <div class="cell info col-2" name="date">{{ $date }}</div>
    <div class="cell info col-3" name="cause">{{ $cause }}</div>
    <div class="cell info col-3" name="result">{{ $result }}</div>
    <div class="cell info col-3" name="characteristics">{{ $characteristics }}</div>
