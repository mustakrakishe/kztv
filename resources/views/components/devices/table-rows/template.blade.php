<tr class="{{ $row_class }}">
    ...
    <td class="codes">
        <div class="info" name="inventory_code" title="Інвентарний код">{{ $inventory_code }}</div>
        <div class="info" name="identification_code" title="Ідентифікаційний код">{{ $identification_code }}</div>
    </td>
