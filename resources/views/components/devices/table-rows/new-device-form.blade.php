<x-devices.table-rows.template>
    <x-slot name="row_class">new-device-form</x-slot>
        ...
        <div class="row">
            <div class="col-6">
                <label class="btn btn-link m-0 p-0">
                    <button class="ok" onclick="add_new_device(event)" hidden></button>
                    <i class="fas fa-check"></i>
                </label>
            </div>
            <div class="col-6">
                <label class="btn btn-link m-0 p-0">
                    <button class="cancel" onclick="cancel_add_new_device(event)" hidden></button>
