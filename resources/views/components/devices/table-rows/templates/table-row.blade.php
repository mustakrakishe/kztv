<tr class="{{ $row_class }}">
    ...
    <td class="codes">
        <div class="info" name="inventory_code" title="Інвентарний номер">{{ $inventory_code }}</div>
        <div class="info" name="identification_code" title="Ідентифікаційний номер">{{ $identification_code }}</div>
    </td>
